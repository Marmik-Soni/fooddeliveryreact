                    ...
                    <ul>
                      <li className="product-item gap14 mb-10">
                        ...
                        <div className="flex items-center justify-between gap20 flex-grow">
                          <div className="name">
                            <a href="/remos/product-list.html" className="body-text">
          ...
          <div className="header-grid">
            ...
            <div className="popup-wrap noti type-header">
              <div className="dropdown">
                ...
                >
                    ...
                    <div className="noti-item w-full wg-user active">
                      ...
                      <div className="flex-grow">
                        <div className="flex items-center justify-between">
                          <a href="/remos/#" className="body-title">
                            Cameron Williamson
                          </a>
                  ...
                  <li>
                    <a href="/remos/#" className="tf-button w-full">
                      View all
                    </a>
                  </li>
                </ul>
            ...
            <div className="popup-wrap user type-header">
              <div className="dropdown">
                ...
                >
                  <li>
                    <a href="/remos/#" className="user-item">
                      <div className="icon">
                  ...
                  <li>
                    <a href="/remos/setting.html" className="user-item">
                      <div className="icon">
                  ...
                  <li>
                    <a href="/remos/login.html" className="user-item">
                      <div className="icon">
