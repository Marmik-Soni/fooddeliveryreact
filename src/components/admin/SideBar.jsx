    ...
    <>
      ...
      <div className="section-menu-left">
        <div className="box-logo">
          <a href="/remos/index.html" id="site-logo-inner">
            <img
              className
              id="logo_header"
              alt
        ...
        <div className="section-menu-left-wrap">
          <div className="center">
                ...
                <li className="menu-item has-children">
                  ...
                  <ul className="sub-menu">
                    <li className="sub-menu-item">
                      <a href="/remos/index.html" className>
                        <div className="text">Home 01</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/home-2.html" className>
                        <div className="text">Home 02</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/home-3.html" className>
                        <div className="text">Home 03</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/home-4.html" className>
                        <div className="text">Home 04</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/home-boxed.html" className>
                        <div className="text">Home Boxed</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/home-menu-icon-hover.html" className>
                        <div className="text">Home Menu Icon Hover</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/home-menu-icon-default.html" className>
            ...
            <div className="center-item">
              ...
              <ul className="menu-list">
                <li className="menu-item has-children">
                  ...
                  <ul className="sub-menu">
                    <li className="sub-menu-item">
                      <a href="/remos/add-product.html" className>
                        <div className="text">Add Product</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/product-list.html" className>
                        <div className="text">Product List</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/product-detail-1.html" className>
                        <div className="text">Product Detail 1</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/product-detail-2.html" className>
                        <div className="text">Product Detail 2</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/product-detail-3.html" className>
                ...
                <li className="menu-item has-children active">
                  ...
                  <ul className="sub-menu" style={{ display: "block" }}>
                    <li className="sub-menu-item">
                      <a href="/remos/category-list.html" className>
                        <div className="text">Category list</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/new-category.html" className="active">
                ...
                <li className="menu-item has-children">
                  ...
                  <ul className="sub-menu">
                    <li className="sub-menu-item">
                      <a href="/remos/attributes.html" className>
                        <div className="text">Attributes</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/add-attributes.html" className>
                ...
                <li className="menu-item has-children">
                  ...
                  <ul className="sub-menu">
                    <li className="sub-menu-item">
                      <a href="/remos/oder-list.html" className>
                        <div className="text">Order list</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/oder-detail.html" className>
                        <div className="text">Order detail</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/oder-tracking.html" className>
                ...
                <li className="menu-item has-children">
                  ...
                  <ul className="sub-menu">
                    <li className="sub-menu-item">
                      <a href="/remos/all-user.html" className>
                        <div className="text">All user</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/add-new-user.html" className>
                        <div className="text">Add new user</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/login.html" className>
                        <div className="text">Login</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/sign-up.html" className>
                ...
                <li className="menu-item has-children">
                  ...
                  <ul className="sub-menu">
                    <li className="sub-menu-item">
                      <a href="/remos/all-roles.html" className>
                        <div className="text">All roles</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/create-role.html" className>
                ...
                <li className="menu-item">
                  <a href="/remos/gallery.html" className>
                    <div className="icon">
                ...
                <li className="menu-item">
                  <a href="/remos/report.html" className>
                    <div className="icon">
            ...
            <div className="center-item">
              ...
              <ul className="menu-list">
                <li className="menu-item has-children">
                  ...
                  <ul className="sub-menu">
                    <li className="sub-menu-item">
                      <a href="/remos/countries.html" className>
                        <div className="text">Countries</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/states.html" className>
                        <div className="text">States</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/cities.html" className>
                ...
                <li className="menu-item">
                  <a href="/remos/setting.html" className>
                    <div className="icon">
                ...
                <li className="menu-item has-children">
                  ...
                  <ul className="sub-menu">
                    <li className="sub-menu-item">
                      <a href="/remos/list-page.html" className>
                        <div className="text">List page</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/new-page.html" className>
                        <div className="text">New page</div>
                      </a>
                    </li>
                    <li className="sub-menu-item">
                      <a href="/remos/edit-page.html" className>
            ...
            <div className="center-item">
              ...
              <ul className="menu-list">
                <li className="menu-item">
                  <a href="/remos/components.html" className>
                    <div className="icon">
          ...
          <div className="bot text-center">
            <div className="wrap">
              <div className="mb-20">
                <img src="/remos//images/menu-left/img-bot.png" alt />
              </div>
              <div className="mb-20">
