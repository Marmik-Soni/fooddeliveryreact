                ...
                <div className="col-xxl-9 col-xl-8">
                  <div className="billing-info">
                    <div className="title-row title-row-2 mb-24">
                      <h3 className="fw-500 color-ter">Register</h3>
                    </div>
                    <div className="billing-wrapper mb-40">
                      <form
                        action="https://uiparadox.co.uk/templates/savory-bites/checkout.html"
                        method="post"
                          ...
                          <div className="col-md-12">
                            <div className="input-block mb-16">
                              <input
                                ...
                                name="text"
                                className="form-control form-control-2 "
                                placeholder="Your Address, House Number "
                              />
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width={20}
                          ...
                          <div className="col-md-12">
                            <div className="input-block mb-16">
                              <input
                                ...
                                name="text"
                                className="form-control form-control-2 "
                                placeholder="Your Address or Street Name "
                              />
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width={20}
                      ...
                      <div className="shipping-radio-container">
                        <form
                          action="https://uiparadox.co.uk/templates/savory-bites/contact.html"
                          method="post"
                          className="mb-32"
                        >
                          <div className="plans mb-16">
                            <label className="plan basic-plan" htmlFor="credit">
                              ...
                              <span className="plan-content content-2">
                                <img
                                  src="/savory/assets/media/icons/payment-card-1.png"
                                  alt
                                />
                                <span className="plan-details">
                                  <span className="fw-500 black">
                          ...
                          <div className="plans mb-16">
                            <label className="plan basic-plan" htmlFor="paypal">
                              ...
                              <span className="plan-content content-2">
                                <img
                                  src="/savory/assets/media/icons/payment-card-2.png"
                                  alt
                                />
                                <span className="plan-details">
                          ...
                          <div className="plans mb-32">
                            <label className="plan basic-plan" htmlFor="bank">
                              ...
                              <span className="plan-content content-2">
                                <img
                                  src="/savory/assets/media/icons/payment-card-3.png"
                                  alt
                                />
                                <span className="plan-details">
                                  <span className="fw-500 black">
                        ...
                        <h6 className="fw-500 color-ter mb-24">
                          Payments Details
                        </h6>
                        <div className="row">
                          <div className="col-md-12">
                          ...
                          <div className="col-md-12">
                            <div className="input-block mb-16">
                              <input
                                ...
                                name="date"
                                id="checkIn"
                                className="form-control form-control-2 date_from"
                            ...
                            <div className="input-block mb-16">
                              ...
                              >
                                <rect
                                  width={20}
                                  height={20}
                                  fill="url(#pattern0_8194_6746)"
                                />
                                <defs>
                                  <pattern
                                    id="pattern0_8194_6746"
                                    patternContentUnits="objectBoundingBox"
                                    width={1}
                                    height={1}
                                  >
                                    <use
                                      xlinkHref="#image0_8194_6746"
                ...
                <div className="col-xxl-3 col-xl-4">
                  <div className="checkout-sidebar">
                    ...
                    <div className="d-flex gap-16 align-items-center mb-16">
                      <img
                        className="br-4"
                        src="/savory/assets/media/blog/check-out-img-1.jpg"
                        alt
                      />
                      <a
                        href="menu.html"
                        className="p sidebar-content fw-600 medium-black"
                      >
                        Hot dog dressed{" "}
                      </a>
                    ...
                    <div className="d-flex gap-16 align-items-center mb-24">
                      <img
                        className="br-4"
                        src="/savory/assets/media/blog/check-out-img-2.jpg"
                        alt
                      />
                      <a
                        href="menu.html"
                    ...
                    <form method="get" className="mb-24">
                      <div className="d-flex gap-16 align-items-center justify-content-between">
                        ...
                        <button
                          type="submit"
                          className="coupon-code-button cus-btn"
                        >
                          apply now
                        </button>
                      </div>
                    ...
                    <p className="mb-16">
                      ...
                      <span className="color-ter">privacy policy.</span>{" "}
                    </p>
                    ...
                    <button type="submit" className="border-0 cus-btn">
                      place order
                    </button>
                  </div>
                </div>
